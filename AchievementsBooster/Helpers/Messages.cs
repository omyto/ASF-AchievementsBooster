...
internal static class Messages {
  ...
  internal static string NoBoostingApps { get; } = "No apps available to boost achievements";
  internal static string NoBoostingAppsInArchiFarming { get; } = "No apps available to boost achievements during farming cards";
  internal static string NoBoostingAppsInArchiPlayedWhileIdle { get; } = "No apps available to boost achievements while playing in idle mode";
}
